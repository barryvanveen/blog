...
<div id="js-mobile-menu-popover" class="hidden">
    <div>
        <div class="fixed inset-0 bg-white overflow-y-auto z-50" role="dialog" aria-modal="true" aria-labelledby="mobile-menu-title">
            <div class="flex flex-col justify-center min-h-screen py-16 px-4 z-10">
                <button id="js-mobile-menu-close" type="button" class="hover-link-color" tabindex="0" aria-label="Close menu">
                ...
                <nav class="text-center" aria-labelledby="mobile-menu-title">
                    ...
                    <ul>
                        @foreach($menu_items as $menu_item)
                            <li class="mb-4">
                                <a type="button" class="text-xl hover-link-color"
                                   href="{{ $menu_item->url() }}"
