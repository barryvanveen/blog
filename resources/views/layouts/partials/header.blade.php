...
<header class="w-full py-6 border-b-4 border-color z-10">
    <div class="container-max-md flex justify-between items-center">
        ...
        <nav class="hidden md:block" aria-labelledby="menu-title">
            ...
            <ul class="inline-flex gap-x-16">
                @foreach($menu_items as $menu_item)
                    <li>
                        <a class="text-lg hover-link-color"
                           href="{{ $menu_item->url() }}"
        ...
        <button id="js-mobile-menu-open" type="button" class="hover-link-color md:hidden" aria-label="Open menu">
